...
public interface FlakyHistoryMapper extends Serializable {
    ...
    @Insert({
        ...
        "#{flakyStatus,jdbcType=INTEGER}, #{detectTime,jdbcType=DATE}, ",
    ...
    @Results({
        ...
        @Result(column="detect_time", property="detectTime", jdbcType=JdbcType.DATE),
    ...
    @Update({
        ...
        "set flaky_id = #{flakyId,jdbcType=INTEGER},",
          ...
          "detect_time = #{detectTime,jdbcType=DATE},",
